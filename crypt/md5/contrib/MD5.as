 ...
 *
 * ported to Actionscript 2.0 by Tim Knip
 *
 * usage:
 * var hash = MD5.calculate('Hello World');
 */

class org.pajhome.crypt.MD5 {

	/*
	 * Configurable variables. You may need to tweak these to be compatible with
	 * the server-side, but the defaults work in most cases.
	 */
	public static var hexcase = 0;  /* hex output format. 0 - lowercase; 1 - uppercase        */
	public static var b64pad  = ""; /* base-64 pad character. "=" for strict RFC compliance   */
	public static var chrsz   = 8;  /* bits per input character. 8 - ASCII; 16 - Unicode      */
	...
	public static function b64_md5(s){ return binl2b64(core_md5(str2binl(s), s.length * chrsz));}
	public static function str_md5(s){ return binl2str(core_md5(str2binl(s), s.length * chrsz));}
